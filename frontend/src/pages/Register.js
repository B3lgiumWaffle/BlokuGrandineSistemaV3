                    ...
                    <SectionCard title="Register" subtitle="Set up a new account in English-only system mode.">
                        ...
                        <Box component="form" onSubmit={onSubmit}>
                            ...
                            <Typography variant="body2" sx={{ mt: 1.5, color: "text.secondary", lineHeight: 1.6 }}>
                                When you create an account, you agree to the Terms of Service of this platform.{" "}
                                <MuiLink component={Link} to="/terms" underline="hover" sx={{ fontWeight: 700 }}>
                                    To read them, press here.
                                </MuiLink>
                            </Typography>
